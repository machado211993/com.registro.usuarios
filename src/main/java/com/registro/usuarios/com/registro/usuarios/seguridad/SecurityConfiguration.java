...
package com.registro.usuarios.com.registro.usuarios.seguridad;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    @Autowired
    private UsuarioServicio usuarioServicio; //estoy inyectando el servicio
    @Bean 
    public BCryptPasswordEncoder passwordEncoder(){
        return new BCryptPasswordEncoder();
    }
    @Bean 
    //son todos metodos de configuracion
